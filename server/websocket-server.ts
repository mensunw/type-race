...
export class TypeRaceWebSocketServer {
  ...
  private readonly DEFAULT_TEXT = `The quick brown fox jumps over the lazy dog. This pangram contains every letter of the English alphabet at least once, making it perfect for typing practice and testing keyboard layouts.`;
